...
export const ScrollVelocity: React.FC<ScrollVelocityProps> = ({
    ...
    function VelocityText({
      ...
      const lastScrollY = useRef(0); // Store the previous scroll position
  
      useAnimationFrame((t, delta) => {
        const scrollDelta = scrollY.get() - lastScrollY.current;
        lastScrollY.current = scrollY.get();
  
        // Flip direction based on the scroll delta (positive or negative scroll direction)
        if (scrollDelta > 0) {
